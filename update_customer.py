...
from update_customer_db import*
...
var=StringVar()
msg_1=Label(Frame0, text="-----: Edit Customer Details :----- ",font=("Times New Roman", 30),fg='blue',bg='yellow',width=41)
msg_1.grid(row=0, column=0, padx=40)
#===================================Frame-1=============================================================================
Frame1 = Frame(root)
Frame1.place(relx=0.03, rely=0.10, relheight=0.55, relwidth=0.93)
Frame1.configure(relief=GROOVE)
Frame1.configure(borderwidth="10")
Frame1.configure(relief=GROOVE)
Frame1.configure(background="#23CDC7")
...
Frame2 = Frame(Frame1)
Frame2.place(relx=0.35, rely=0.77, relheight=0.19, relwidth=0.35)
Frame2.configure(relief=GROOVE)
Frame2.configure(borderwidth="8")
Frame2.configure(relief=GROOVE)
Frame2.configure(background="#23CDC7")#563BDB
...
Frame3 = Frame(root)
Frame3.place(relx=0.03, rely=0.65, relheight=0.20, relwidth=0.93)
Frame3.configure(relief=GROOVE)
Frame3.configure(borderwidth="10")
Frame3.configure(relief=GROOVE)
Frame3.configure(background="#720BBC")
Frame3.configure(highlightbackground="#ffffff")
Frame3.configure(highlightcolor="black")
Frame3.configure(width=93)
#------------------------------------------Show Customer Details--------------------------
Lbl_1=Label(Frame3,text='''Show Customer Details''',bg='#720BBC',font='bold, 20',fg='white')
...
#-====================================1-Customer Id=====================================================================
Lbl_1=Label(Frame1,text='''Customer Id''',bg='#23CDC7',font='bold, 15',width=20,highlightcolor="black",fg='white')
Lbl_1.place(relx=0.0, rely=0.03, height=47)

Lbl_2=Label(Frame1, text=''':''', bg='#23CDC7', font='bold, 15', borderwidth="2",highlightcolor="black",fg='white')
Lbl_2.place(relx=0.25, rely=0.03, height=47,width=26)
#-====================================1-Customer Id(Entry_{box)=========================================================
...
Lbl_1=Label(Frame1,text='''Customer Name''',bg='#23CDC7',font='bold, 15',width=20,highlightcolor="black",fg='white')
...
Lbl_1=Label(Frame1,text='''Customer Address''',bg='#23CDC7',font='bold, 15',width=20,highlightcolor="black",fg='white')
...
Lbl_1=Label(Frame1,text='''Gender        ''',bg='#23CDC7',font='bold, 15',width=20,highlightcolor="black",fg='white')
...
Lbl_1=Label(Frame1,text='''Mobile Number''',bg='#23CDC7',font='bold, 15',width=20,highlightcolor="black",fg='white')
Lbl_1.place(relx=0.02, rely=0.51, height=47)

Lbl_4=Label(Frame1, text=''':''', bg='#23CDC7', font='bold, 15', borderwidth="2",highlightcolor="black",fg='white')
...
Lbl_1=Label(Frame1,text='''E-mail     ''',bg='#23CDC7',font='bold, 15',highlightcolor="black",fg='white')
Lbl_1.place(relx=0.06, rely=0.63, height=47)

Lbl_2=Label(Frame1, text=''':''', bg='#23CDC7', font='bold, 15',fg='white')
...
def update():
    ...
    address = str(Entry_3.get())
    gender = str(combo_gender.get())
    mobile_no = str(Entry_4.get())
    email_id = str(Entry_5.get())
    #gender=None
    customer_update_record(customer_name, address, gender, email_id, mobile_no,customer_id)
    #messagebox.showinfo("Submit","Update Sucess")

#==============================Update & Exit Button============================================================================
sbmitbtn = Button(Frame2, text = "Update",command=update,width='6',height='1',font='5',bd='5',bg='#77B81D',fg='white',
                  activebackground = "green", activeforeground = "magenta").place(relx=0.01,rely=0.05)

sbmitbtn = Button(Frame2,command=quit ,text = "Exit",width='6',height='1',font='5',bd='5',bg='#CD237A',fg='white',
                  activebackground = "green", activeforeground = "magenta").place(relx=0.72,rely=0.06)#56 08

#=====================================Reset/Clearing entry box details-=================================================
def clearFunc():
...
clear_btn = Button(Frame2, text = "Clear",command=clearFunc,width='10',height='1',font='5',bd='5',bg='red',fg='white',
                  activebackground = "green", activeforeground = "magenta").place(relx=0.29,rely=0.05)
root.mainloop()
